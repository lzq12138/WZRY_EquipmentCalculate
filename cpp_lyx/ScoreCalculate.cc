...
static double extra_attribute_factor[N_ATTR] = {HP_FACTOR2, MP_FACTOR2, AD_FACTOR2, AP_FACTOR2, PD_FACTOR2, MD_FACTOR2, MS_FACTOR2, PPen_FACTOR2, MPen_FACTOR2, AS_FACTOR2, CR_FACTOR2, CD_FACTOR2, LS_FACTOR2, SV_FACTOR2, CDR_FACTOR2, Tenacity_FACTOR2, HReg_FACTOR2, MReg_FACTOR2};
